...
import static com.example.alessandro.tcc.FuncionarioDBOpenHelper.TABLE_FUNCIONARIO;
...
public class FuncionarioDBController {
    ...
    public Cursor loadItems(){
        ...
        cursor = db.query(funcionarioDB.TABLE_FUNCIONARIO, funcionarioDB.COLUNA, null, null, null, null, null, null);
