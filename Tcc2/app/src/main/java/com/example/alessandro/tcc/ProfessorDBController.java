...
import static com.example.alessandro.tcc.ProfessorDBOpenHelper.TABLE_PROFESSOR;
...
public class ProfessorDBController {
    ...
    public Cursor loadItems(){
        ...
        cursor = db.query(professorDB.TABLE_PROFESSOR, professorDB.COLUNA, null, null, null, null, null, null);
