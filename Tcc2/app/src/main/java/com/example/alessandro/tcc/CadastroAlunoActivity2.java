...
public class CadastroAlunoActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Aluno aluno = new Aluno(nome,cpf,rg,nacionalidade,sexo,naturalidade,endereco,dt,tel,email,senha,turma.getText().toString(),
                cota,curso.getText().toString(),Integer.parseInt(matricula.getText().toString()),null,
                Double.parseDouble(nota_entrada.getText().toString()),0,0,null,null);

        AlunoDBController alunoDBController = new AlunoDBController(this);
